...
function Menu(){
    ...
    function toggleGroupListMobile(){
        const groupsListMB = document.querySelector(".groups-list-mb");
        if(groupsListMB.style.transform == "translateY(0%)" ){
            console.log("attempt to close");
            groupsListMB.style.transform ="translateY(200%)";
            groupsListMB.style.opacity = 0;
            groupsListMB.style.pointerEvents = "none";
        }else{
            console.log("attempt to open");
            groupsListMB.style.transform ="translateY(0%)";
            groupsListMB.style.opacity = 1;
            groupsListMB.style.pointerEvents = "all";
        }
    }
        ...
        <header ref = {headerRef}>
            ...
            <div className="header-bottom">
                <div className="options-mobile">
                    <div className="options-mobile-left notes-mobile">
                        <figure className="sm-menu-icon"  onClick={(e)=>{e.preventDefault();filterGroup("All")}}>
                        ...
                        <figure className="sm-menu-icon groups-mobile" onClick={()=>{toggleGroupListMobile()}}>
                            <ul className="groups-list-mb">
                                    {groups.map((group, i)=>
                                        <li
                                            key={i}
                                            className="group"
                    ...
                    <div className="options-mobile-right">
                        <figure className="sm-menu-icon" onClick={()=>{openPopUp()}}>
                        ...
                        <figure className="sm-menu-icon trash-mobile"  onClick={(e)=>{e.preventDefault();filterGroup("Trash")}}>
